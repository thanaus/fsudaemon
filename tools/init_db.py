...
async def init_database():
    ...
    try:
        # All DDL statements are wrapped in a single transaction.
        # If any step fails, the entire schema initialization is rolled back,
        # preventing a partial/inconsistent database state.
        async with conn.transaction():
            ...
            await conn.execute("""
                ...
                BEGIN
                    ...
                    -- On DELETE, NEW is NULL — return OLD to satisfy PostgreSQL trigger protocol.
                    -- On INSERT / UPDATE, return NEW as usual.
        ...
        # Transaction committed — schema is fully applied
        ...
        # Display statistics (outside transaction — read-only, no need to be inside)
